...
spark-submit --conf spark.sql.extensions=org.apache.spark.sql.lineage.TitianSQLExtension,org.apache.spark.sql.watchpoint.WatchpointExtension ...
...
```bash
bin/sbt 'examples/runMain org.bigasterisk.examples.AblationBenchmark [rows] [iters]'
```
