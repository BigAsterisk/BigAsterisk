...
bin/sbt 'examples/runMain org.bigasterisk.examples.CaptureOverheadBenchmark 2000000'

# ablation benchmark: every optimization config (rows, iters)
bin/sbt 'examples/runMain org.bigasterisk.examples.AblationBenchmark 2000000 7'
...
| `BIGASTERISK_HOME` / `FASTUTIL_JAR` | notebook bootstrap overrides |
