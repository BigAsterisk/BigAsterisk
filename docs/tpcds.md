...
- `gen_data.py` — generates the 24 tables as Parquet with DuckDB's built-in `dsdgen`
  ...
  (gitignored).
- Runner: `org.bigasterisk.examples.TPCDSCoverage` (in `examples/`). Per query:
...
sbt 'examples/runMain org.bigasterisk.examples.TPCDSCoverage'
sbt 'examples/runMain org.bigasterisk.examples.TPCDSCoverage tpcds/data/sf0.2 tpcds/queries q3,q88'
```
...
```bash
sbt 'examples/runMain org.bigasterisk.examples.TPCDSCoverage tpcds/data/sf0.2 tpcds/queries --oracle'
...
sbt 'examples/runMain org.bigasterisk.examples.TPCDSCoverage tpcds/data/sf0.2 tpcds/queries q3 --oracle'
```
