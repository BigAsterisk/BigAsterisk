 ...
 * delta).
 *
 *   bin/sbt 'examples/runMain org.bigasterisk.examples.WeatherAnalysisDemo'
 */
object WeatherAnalysisDemo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = if (args.nonEmpty) args(0) else "modules/spark4/src/test/resources/socc_weather.csv"
