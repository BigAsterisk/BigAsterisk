...
submit "$ROOT/python/tests/test_perfdebug_pyspark.py"
submit "$ROOT/python/tests/test_influence_pyspark.py"
submit "$ROOT/python/tests/test_fuzz_pyspark.py"
...
submit "$ROOT/python/tests/test_ui_pyspark.py"
